                        ...
                        <?php $i = 0; foreach ($packages as $row) { $i++; ?>
                            <tr class="eventpointer">
                                ...
                                <td class="action-link">
                                    <a href="<?php echo base_url(); ?>package/edit/<?php echo $row->packid; ?>"><span class="label label-warning"><i class="fas fa-edit"></i></span></a>
                                    <a href="<?php echo base_url(); ?>package/delete/<?php echo $row->packid; ?>"><span class="label label-danger delete"><i class="fas fa-times-circle"></i></span></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
