                            ...
                            <tr class="even pointer">
                                ...
                                <?php if(hotspotUser($row('name')) != false){ ?>
                                    <td class="action-link">
                                        <a href="<?php echo base_url(); ?>user/view/<?php echo hotspotUser($row('name'))->id; ?>/"><span class="label label-success"><i class="fas fa-external-link-square-alt"></i></span></a>
                                        <a href="<?php echo base_url(); ?>user/edit/<?php echo hotspotUser($row('name'))->id; ?>/" ><span class="label label-warning"><i class="fas fa-edit"></i></span></a>
                                        <a href="<?php echo base_url(); ?>user/delete/<?php echo hotspotUser($row('name'))->id; ?>/" ><span class="label label-danger delete"><i class="fas fa-times-circle"></i></span></a>
                                    </td>
                                <?php }else{ ?>
                                    <td class="action-link">
