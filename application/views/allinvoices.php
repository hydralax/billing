                                ...
                                <td class="action-link">
                                    ...
                                    <?php if(getUser($row->userid)){ ?>
                                      ...
                                      <?php if(package(getUser($row->userid)->package)){ ?>
                                        <a href="<?php echo base_url(); ?>invoice/view/<?php echo $row->invoiceID; ?>"><span class="label label-primary"><i class="fas fa-external-link-square-alt"></i></span></a>
                                      <?php }else{ ?>
                                    ...
                                    <a href="<?php echo base_url(); ?>invoice/delete/<?php echo $row->invoiceID; ?>"><span class="label label-danger delete"><i class="fas fa-times-circle"></i></span></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
