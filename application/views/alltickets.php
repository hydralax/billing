                    ...
                    <tbody>
                        <?php $i = 0; foreach ($tickets as $row) { $i++; ?>
                            <tr class="eventpointer">
                                ...
                                <td class="action-link">
                                    <a href="<?php echo base_url(); ?>ticket/view/<?php echo $row->ticketID; ?>"><span class="label label-primary"><i class="fas fa-external-link-square-alt"></i></span></a>
                                    <a href="<?php echo base_url(); ?>ticket/edit/<?php echo $row->ticketID; ?>"><span class="label label-warning"><i class="fas fa-edit"></i></span></a>
                                    <?php if(notAdmin() == true){ ?>
                                        <a href="<?php echo base_url(); ?>ticket/solve/<?php echo $row->ticketID; ?>"><span class="label label-success"><i class="fas fa-window-close"></i></span></a>
                                        <a href="<?php echo base_url(); ?>ticket/delete/<?php echo $row->ticketID; ?>"><span class="label label-danger delete"><i class="fas fa-times-circle"></i></span></a>
                                    <?php } ?>
