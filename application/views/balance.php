        ...
        <div class="x_content">
            <div class="col-md-6">
                ...
                <form class="form-horizontal form-label-left" role="form" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>balance/bymonth" accept-charset="utf-8">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                            <button id="send" type="submit" class="btn btn-success"><i class="fas fa-search"></i> Browse Now</button>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    foreach ($balances as $row) {
                        ...
                        <tr class="eventpointer">
                            ...
                            <td class="action-link">
                                <a href="<?php echo base_url(); ?>balance/edit/<?php echo $row->id; ?>"><span class="label label-warning"><i class="fas fa-edit"></i></span></a>
                                <a href="<?php echo base_url(); ?>balance/delete/<?php echo $row->id; ?>"><span class="label label-danger delete"><i class="fas fa-times-circle"></i></span></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
