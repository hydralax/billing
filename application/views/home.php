...
<div class="col-md-11 col-sm-11 col-xs-11 rightSideWrapper">
    ...
    <div class="col-md-12">
                        ...
                        foreach ($users as $row) {
                            ...
                            <tr class="even pointer">
                                ...
                                <td class="action-link">
                                    <a href="<?php echo base_url(); ?>user/view/<?php echo $row->id; ?>/"><span class="label label-success"><i class="fas fa-external-link-square-alt"></i></span></a>
                                    <a href="<?php echo base_url(); ?>user/edit/<?php echo $row->id; ?>/"><span class="label label-warning"><i class="fas fa-edit"></i></span></a>
                                    <a href="<?php echo base_url(); ?>user/delete/<?php echo $row->id; ?>/" ><span class="label label-danger delete"><i class="fas fa-times-circle"></i></span></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
        ...
        <div class="col-md-6">
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fas fa-chart-bar"></i> Payment & Income/Expense Chart</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fas fa-chart-bar"></i> Area & Staff Chart</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <div class="row tile_count">
                    <div class="col-md-6">
                    <p class="text-center">Total Users Under Area</p>
                        <canvas id="areaChart" width="400" height="200"></canvas>
                    </div>
                    <div class="col-md-6">
                    <p class="text-center">Total Users Under Staff</p>
        ...
        <div class="x_panel">            
            <div class="x_title">
                ...
                <div class="x_content">
                    <div class="row tile_count">
                        <div class="animated flipInY col-md-6 col-sm-6 col-xs-6 tile_stats_count mb-30">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fas fa-chart-bar"></i> Invoice Statistics</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <div class="row tile_count">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fas fa-chart-bar"></i> Payment Statistics</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <div class="row tile_count">
                    ...
                    <div class="row tile_count">
                        <div class="animated flipInY col-md-4 col-sm-4 col-xs-4 tile_stats_count">
                            <span class="count_top"><i class="material-icons">assignment_turned_in</i> Total Amount</span>
                            <div class="count blue"><?php
                        ...
                        <div class="animated flipInY col-md-4 col-sm-4 col-xs-4 tile_stats_count">
                            <span class="count_top"><i class="material-icons">assignment_turned_in</i> Month's Amount</span>
                            <div class="count blue"><?php
                                $this->db->select_sum('amount');
                                $this->db->from('payments');
                                $this->db->where('month(saletime)', date('m'));
                        ...
                        <div class="animated flipInY col-md-4 col-sm-4 col-xs-4 tile_stats_count">
                            <span class="count_top"><i class="material-icons">assignment_turned_in</i> Year's Amount </span>
                            <div class="count blue"><?php
                                $this->db->select_sum('amount');
                                $this->db->from('payments');
                                $this->db->where('year(saletime)', date('Y'));
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fas fa-chart-bar"></i> Income/Expense Statistics</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <div class="row tile_count">
                        <div class="animated flipInY col-md-4 col-sm-4 col-xs-4 tile_stats_count">
                            <span class="count_top"><i class="material-icons">attach_money</i> Total Income</span>
                            <div class="count green"><?php
                                $this->db->select_sum('amount');
                        ...
                        <div class="animated flipInY col-md-4 col-sm-4 col-xs-4 tile_stats_count">
                            <span class="count_top"><i class="material-icons">attach_money</i> This Month</span>
                            <div class="count green"><?php
                                $this->db->select_sum('amount');
                                $this->db->from('balance');
                                $this->db->like('type', 'Income');
                        ...
                        <div class="animated flipInY col-md-4 col-sm-4 col-xs-4 tile_stats_count">
                            <span class="count_top"><i class="material-icons">attach_money</i> This Year</span>
                            <div class="count green"><?php
                                $this->db->select_sum('amount');
                                $this->db->from('balance');
                                $this->db->like('type', 'Income');
                    ...
                    <div class="row tile_count">
                        <div class="animated flipInY col-md-4 col-sm-4 col-xs-4 tile_stats_count">
                            <span class="count_top"><i class="material-icons">attach_money</i> Total Expense</span>
                            <div class="count red"><?php
                                $this->db->select_sum('amount');
                                $this->db->from('balance');
