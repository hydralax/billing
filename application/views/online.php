    ...
    <div class="col-md-11 col-sm-11 col-xs-11 rightSideWrapper">
        <div class="x_panel">
            <div class="x_title">
                <h2><i class="material-icons">group</i> All Online Users</h2>
                    ...
                    <tbody>
                        <?php $i = 0; foreach ($users as $row) { $i++; ?>
                            ...
                            <tr class="even pointer">
                                ...
                                <td class="action-link"><a href="<?php echo base_url(); ?>user/view/<?php echo $row->id; ?>/"><span class="label label-success"><i class="fas fa-external-link-square-alt"></i></span></a>
