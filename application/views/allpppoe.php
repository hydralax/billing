    ...
    <div class="col-md-11 col-sm-11 col-xs-11 rightSideWrapper">
        <a class="btn btn-primary right" data-toggle="modal" data-target="#addPPPoEUser"><i class="fa fa-plus fa-fw m-right-xs"></i> Add/Connect PPPoE User With Portal User</a>
        <div class="x_panel">
            <div class="x_title">
                                ...
                                <tr class="even pointer">
                                    ...
                                    <?php if(pppoeUser($row('name')) != false){ ?>
                                        <td class="action-link">
                                            <a href="<?php echo base_url(); ?>user/view/<?php echo pppoeUser($row('name'))->id; ?>/"><span class="label label-success"><i class="fas fa-external-link-square-alt"></i></span></a>
                                            <a href="<?php echo base_url(); ?>user/edit/<?php echo pppoeUser($row('name'))->id; ?>/" ><span class="label label-warning"><i class="fas fa-edit"></i></span></a>
                                            <a href="<?php echo base_url(); ?>user/delete/<?php echo pppoeUser($row('name'))->id; ?>/" ><span class="label label-danger delete"><i class="fas fa-times-circle"></i></span></a>
                                        </td>
                                    <?php }else{ ?>
                                        <td class="action-link">
