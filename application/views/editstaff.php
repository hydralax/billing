    ...
    <div class="col-md-11 col-sm-11 col-xs-11 rightSideWrapper">
        <div class="x_panel">
            <div class="x_title">
                <h2><i class="material-icons">perm_identity</i> Update Staff</h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <?php foreach ($singleStaff as $row) : ?>

                <form class="form-horizontal form-label-left" role="form" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>staff/update" accept-charset="utf-8">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control col-md-7 col-xs-12" name="name" type="text" placeholder="Staff/Line Man Name" value="<?php echo $row->name; ?>" required>
                        </div>
                    </div>
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Contact <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control col-md-7 col-xs-12" name="mobile" type="text" placeholder="Staff Contact" value="<?php echo $row->mobile; ?>" required>
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <?php $i = 0; foreach ($staff as $row) { $i++; ?>
                            <tr class="eventpointer">
                                ...
                                <td class="action-link">
                                    <a href="<?php echo base_url(); ?>staff/edit/<?php echo $row->id; ?>"><span class="label label-warning"><i class="fas fa-edit"></i></span></a>
                                    <a href="<?php echo base_url(); ?>staff/delete/<?php echo $row->id; ?>"><span class="label label-danger delete"><i class="fas fa-times-circle"></i></span></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
