    ...
    <div class="col-md-11 col-sm-11 col-xs-11 rightSideWrapper">
        <div class="x_panel">
            <div class="x_title">
                <h2><i class="material-icons">my_location</i> Add Area</h2>
                ...
                <form class="form-horizontal form-label-left" role="form" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>area/insert" accept-charset="utf-8">
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control col-md-7 col-xs-12" name="name" type="text" placeholder="Area Name" required>
                        </div>
                    </div>
                    <div class="ln_solid"></div>
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                            <button id="send" type="submit" class="btn btn-success"><i class="fas fa-plus"></i> Add Now</button>
                        </div>
                    </div>
                </form>
            </div>
                        ...
                        <?php $i = 0; foreach ($area as $row) { $i++; ?>
                            <tr class="eventpointer">
                                ...
                                <td class="action-link">
                                    <a href="<?php echo base_url(); ?>area/edit/<?php echo $row->id; ?>"><span class="label label-warning"><i class="fas fa-edit"></i></span></a>
                                    <a href="<?php echo base_url(); ?>area/delete/<?php echo $row->id; ?>"><span class="label label-danger delete"><i class="fas fa-times-circle"></i></span></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
